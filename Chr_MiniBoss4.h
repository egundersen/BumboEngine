...
public:
    Chr_MINIBOSS4(int center_position_x, int center_position_y, int &player_health, int unique_object_ID, int screen_width, int screen_height, std::vector<std::vector<char>> &world_matrix, std::vector<std::vector<std::pair<int, int>>> &element_has_object, std::vector<std::vector<std::string>> &matrix_display, std::pair<std::string, int> &image_file_path,
                  ...
                  22, // Boss health
                  "Mini Boss 4", // name
                   "resources\\mini boss 4_neuHappy.png", // Neutral Expression (Image Location/Name)
                   "resources\\mini boss 4_angry.png", // Angry Expression (Image Location/Name)
                    "resources\\mini boss 4_neuHappy.png",
                    "resources\\mini boss 4_nervousDead.png"
                                                                                  ),//*/
