...
#include <algorithm>
#include <Windows.h>
AttackPattern_SnakeandExplode::AttackPattern_SnakeandExplode(int width, int height, std::vector<std::vector<std::string>>& matrix_display, int & player_health, int number_of_attacks)
