...
#ifndef CHR_AKIAFTERSHARKTOOTH_H
#define CHR_AKIAFTERSHARKTOOTH_H

class Chr_AkiAfterSharktooth : public CharacterBase
{
public:
	Chr_AkiAfterSharktooth(int center_position_x, int center_position_y, int unique_object_ID, WorldSprite world_sprite, char direction, int &player_health, int screen_width, int screen_height, Matrix &world_matrix, std::vector<std::vector<std::pair<int, int>>> &element_has_object, Matrix &screen_matrix, BitmapDefinition &image_file_path)
...
#endif // !CHR_AKIAFTERSHARKTOOTH_H
