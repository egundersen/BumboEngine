...
struct BossFightDefinition
{
	...
	BossFightDefinition(int boss_health, int overlay_x_offset, int overlay_y_offset, std::string boss_name, std::string boss_ascii_art, std::string overlay_ascii)
		...
		file_path_neutral{ "" }, file_path_angry{ "" }, file_path_happy{ "" }, file_path_nervous_dead{ "" } {}
	BossFightDefinition(int boss_health, std::string boss_name, std::string image_file_name_neutral, std::string image_file_name_angry, std::string image_file_name_happy, std::string image_file_name_nervous_dead)
	...
	std::string name, ascii, overlay, file_path_neutral, file_path_angry, file_path_happy, file_path_nervous_dead;
};
