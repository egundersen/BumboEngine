...
public:
	...
	Item(std::string item_name, int modifier, std::string description = "") : item_name_{ item_name }, description_{ description }, image_{ "/  \\Z|O |Z\\_ /Z" }, modifier_{ modifier }, item_type_{ "HEAL" }, use_item_{ false } {}
	...
	Item(std::string item_name, std::string item_type, int modifier, std::string description = "") : item_name_{ item_name }, description_{ description }, image_{ "/  \\Z|O |Z\\_ /Z" }, modifier_{ modifier }, item_type_{ item_type }, use_item_{ false } {}
