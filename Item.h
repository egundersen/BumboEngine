...
public:
	...
	Item(std::string item_name, std::string item_type, int modifier, std::string description = "") : item_name_{ item_name }, description_{ description }, image_{ "/  \\Z|O |Z\\_ /Z", "Y  YZYR YZYY YZ" }, modifier_{ modifier }, item_type_{ item_type }, use_item_{ false } {}
