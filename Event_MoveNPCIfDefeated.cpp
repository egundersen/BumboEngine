...
{
	if (getCharacterByID(defeated_character_ID_) == nullptr || getCharacterByID(defeated_character_ID_)->isBattleOver())
		return true;
	else
		return false;
}
