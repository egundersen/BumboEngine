...
void AttackPattern_SnakeHailStorm::OnBeginAttack()
{
...
void AttackPattern_SnakeHailStorm::refreshScreen()
{
...
void AttackPattern_SnakeHailStorm::createAttack(int reverse_direction, int position_2D_, int speed)
{
...
void AttackPattern_SnakeHailStorm::createSnake(int head_position_x, int head_position_y, int duration_of_attack, int speed)
{
	Attack_Snake *attack;
