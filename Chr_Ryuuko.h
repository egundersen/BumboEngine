...
{
public:
	Chr_Ryuuko(int center_position_x, int center_position_y, int unique_object_ID, WorldSprite world_sprite, char direction, int &player_health, int screen_width, int screen_height, Matrix &world_matrix, std::vector<std::vector<std::pair<int, int>>> &element_has_object, Matrix &screen_matrix, BitmapDefinition &image_file_path,
	...
	void initializeAttackPatterns(int screen_width, int screen_height, Matrix &screen_matrix, int &player_health)
	{
		for (int i = 0; i < 6; i++)
		{
			...
			attack_pattern_1 = new AttackPattern_Snake(screen_width, screen_height, screen_matrix, player_health, 1);
			AttackPatternBase *attack_pattern_2;
			attack_pattern_2 = new Explode_Slowest(screen_width, screen_height, screen_matrix, player_health, 10);
			AttackPatternBase *attack_pattern_3;
			attack_pattern_3 = new AttackPattern_Snake(screen_width, screen_height, screen_matrix, player_health, 2);
			AttackPatternBase *attack_pattern_4;
			attack_pattern_4 = new AttackPattern_ShootAtPlayer(screen_width, screen_height, screen_matrix, player_health, 50);
			AttackPatternBase *attack_pattern_5;
			attack_pattern_5 = new AttackPattern_Snake(screen_width, screen_height, screen_matrix, player_health, 3);
			AttackPatternBase *attack_pattern_6;
			attack_pattern_6 = new VerticleGap_Slow(screen_width, screen_height, screen_matrix, player_health);
