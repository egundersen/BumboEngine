...
{
public:
	Chr_AkiFinal(int center_position_x, int center_position_y, int unique_object_ID, WorldSprite world_sprite, char direction, int &player_health, int screen_width, int screen_height, Matrix &world_matrix, std::vector<std::vector<std::pair<int, int>>> &element_has_object, Matrix &screen_matrix, BitmapDefinition &image_file_path,
	...
	void initializeAttackPatterns(int screen_width, int screen_height, Matrix &screen_matrix, int &player_health)
	{
		for (int i = 0; i < 6; i++)
		{
			...
			attack_pattern_3 = new AttackPattern_Wall(screen_width, screen_height, screen_matrix, player_health, 10, 5, 1);
			...
			attack_pattern_7 = new AttackPattern_Wall(screen_width, screen_height, screen_matrix, player_health, 10, 3, 1);
			...
			attack_pattern_10 = new AttackPattern_Wall(screen_width, screen_height, screen_matrix, player_health, 10, 1, 1);
